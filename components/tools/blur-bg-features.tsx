...
export function BlurBgFeatures() {
            ...
            <div className={feat.inverted ? 'lg:order-1' : ''}>
              <div className="relative">
                ...
                <div className="relative bg-white rounded-2xl shadow-card border border-cream-200 overflow-hidden aspect-[4/3]">
                  <div className="w-full h-full bg-gradient-to-br from-cream-100 to-rose-gold-50 flex items-center justify-center relative">
                    {/* Simulated blur effect visual */}
                    <div className="absolute inset-0 bg-gradient-to-br from-rose-gold-200/40 to-cream-300/60 blur-md" />
                    <div className="relative w-1/3 aspect-[3/4] bg-gradient-to-br from-rose-gold-300 to-rose-gold-500 rounded-xl shadow-lg" />
                  </div>
                </div>
              </div>
            </div>
