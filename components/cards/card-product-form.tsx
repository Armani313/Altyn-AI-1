...
export function CardProductForm({
  ...
  const copy = locale === 'ru'
    ? {
        sectionTitle: 'Информация о продукте',
        productPlaceholder: 'Название продукта',
        brandPlaceholder: 'Название бренда',
        descriptionAdded: 'Описание добавлено',
        addDescription: 'Добавить описание',
        descriptionPlaceholder: 'Опишите продукт, его особенности, ключевые характеристики…',
      }
    : {
        ...
        descriptionPlaceholder: 'Describe the product, its features, and key details…',
      }
        ...
        >
          <span className="flex items-center gap-2">
            ...
            <span className="font-medium">
              {productDescription.trim() ? copy.descriptionAdded : copy.addDescription}
            </span>
