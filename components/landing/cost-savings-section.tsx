      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="relative bg-white rounded-2xl shadow-card border border-cream-200 p-8">
              {/* Cost comparison */}
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6">
              {stats.map(({ value, label }) => (
                <div key={label}>
                  <p className="font-serif text-3xl font-bold text-primary leading-none">{value}</p>
