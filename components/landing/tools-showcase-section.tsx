          ...
          {tools.map((tool) => (
            <motion.div key={tool.title} variants={cardVariants}>
              <Link href={tool.href} className="block group">
                <div className="relative bg-white border border-cream-200 rounded-2xl p-6 hover:border-rose-gold-200 hover:shadow-card transition-all duration-300 h-full">
